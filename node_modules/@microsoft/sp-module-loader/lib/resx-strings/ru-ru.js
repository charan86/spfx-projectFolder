define([], function() {
  var strings = {
    "_D2Ups1G4nZEu0oTY7FfRsA": {
      "platformOrApplicationFailedToLoadError": "{0} или {1} не удалось выполнить загрузку.",
      "applicationFailedToInitializeError": "Сбой инициализации приложения. Ошибка: {0}",
      "applicationFailedToLoadError": "{0} не удалось выполнить загрузку. Ошибка: {1}",
      "invalidManifestError": "Недопустимый манифест {0}.",
      "invaliPreloadedDataError": "Недопустимые предварительно загруженные данные.",
      "manifestNotFoundError": "Манифест {0} не найден.",
      "debugManifestLoadingWarning": "ПРЕДУПРЕЖДЕНИЕ. На этой странице запрашивается загрузка небезопасных сценариев, которые могут нанести вред компьютеру! Продолжайте работу, только если доверяете разработчику и осознаете риски.\\n\\nЕсли вы не уверены, нажмите кнопку \"Отмена\"."
    },
    "_5v0SS2hk3k5Txrl8SXQ7pA": {
      "unableToResolveConfigError": "Не удается определить настройки для модуля {0}.",
      "invalidFrameworkModuleError": "Недопустимый модуль платформы {0}."
    },
