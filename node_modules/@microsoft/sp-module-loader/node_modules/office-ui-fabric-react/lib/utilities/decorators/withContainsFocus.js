...
function withContainsFocus(ComposedComponent) {
    return (function (_super) {
        ...
        WithContainsFocusComponent.prototype.render = function () {
            ...
            return (React.createElement("div", {ref: 'root', onFocus: this._handleFocus.bind(this), onBlur: this._handleBlur.bind(this)}, React.createElement(ComposedComponent, __assign({ref: this._updateComposedComponentRef, containsFocus: containsFocus}, this.props))));
        };
