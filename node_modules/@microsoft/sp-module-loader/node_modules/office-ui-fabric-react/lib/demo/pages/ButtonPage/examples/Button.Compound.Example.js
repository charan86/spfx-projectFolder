...
var ButtonCompoundExample = (function (_super) {
    ...
    ButtonCompoundExample.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'ms-BasicButtonsExample'}, React.createElement(index_1.Label, null, "Compound button"), React.createElement(index_1.Button, {disabled: isDisabled, buttonType: index_1.ButtonType.compound, description: 'You can create a new account here.'}, "Create account")));
    };
