...
var LayerHostedExample = (function (_super) {
    ...
    LayerHostedExample.prototype.render = function () {
        ...
        return (React.createElement(index_1.LayerHost, {className: 'LayerExample-customHost'}, React.createElement("p", null, "In some cases, you may need to contain layered content within an area. Wrap the area with a LayerHost, and it will render content at the end of host's area."), React.createElement(index_1.Checkbox, {label: 'Wrap the content box belowed in a Layer', checked: showLayer, onChange: function (ev, checked) { return _this.setState({ showLayer: checked }); }}), showLayer ? React.createElement(index_1.Layer, null, content) : content, React.createElement("div", {className: 'LayerExample-nonLayered'}, "I am normally below the content.")));
    };
