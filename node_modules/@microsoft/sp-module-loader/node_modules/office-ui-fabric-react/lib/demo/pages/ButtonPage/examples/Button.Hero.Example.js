...
var ButtonHeroExample = (function (_super) {
    ...
    ButtonHeroExample.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'ms-BasicButtonsExample'}, React.createElement(index_1.Label, null, "Hero button"), React.createElement(index_1.Button, {disabled: isDisabled, buttonType: index_1.ButtonType.hero, icon: 'Add'}, "Create account")));
    };
