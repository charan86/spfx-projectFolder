...
exports.SuggestedDocumentItem = function (documentProps) {
    return (React.createElement("div", null, " ", documentProps.documentTitleProps.title, " "));
};
...
exports.SelectedDocumentItem = function (documentProps) {
    ...
    return (React.createElement(index_1.DocumentCard, {onClick: function () { console.log('You clicked the card.'); }}, React.createElement(index_1.DocumentCardPreview, __assign({}, documentPreviewProps)), React.createElement(index_1.DocumentCardLocation, {location: 'Marketing Documents', locationHref: 'http://microsoft.com', ariaLabel: 'Location, Marketing Documents'}), React.createElement(index_1.DocumentCardTitle, __assign({}, documentTitleProps)), React.createElement(index_1.DocumentCardActivity, __assign({}, documentActivityProps)), React.createElement(index_1.DocumentCardActions, {actions: actions})));
};
...
var DocumentPicker = (function (_super) {
    ...
    DocumentPicker.prototype.render = function () {
        ...
        return (React.createElement("div", null, React.createElement("div", {ref: this._resolveRef('root'), className: 'ms-BasePicker', onKeyDown: this.onKeyDown}, React.createElement(index_1.SelectionZone, {selection: this.selection}, React.createElement("div", {className: 'ms-BasePicker-text'}, React.createElement("input", {ref: this._resolveRef('input'), onFocus: this.onInputFocus, onChange: this.onInputChange, value: displayValue, className: 'ms-BasePicker-input'})))), React.createElement(index_1.FocusZone, {ref: this._resolveRef('focusZone')}, this.renderItems()), this.renderSuggestions()));
    };
