...
var TeachingBubblePage = (function (_super) {
    ...
    TeachingBubblePage.prototype.render = function () {
        return (React.createElement(index_2.ComponentPage, {title: 'TeachingBubble', componentName: 'TeachingBubbleExample', exampleCards: React.createElement(index_1.LayerHost, null, React.createElement(index_2.ExampleCard, {title: 'TeachingBubble', code: TeachingBubbleBasicExampleCode}, React.createElement(TeachingBubble_Basic_Example_1.TeachingBubbleBasicExample, null)), React.createElement(index_2.ExampleCard, {title: 'TeachingBubble Condensed', code: TeachingBubbleCondensedExampleCode}, React.createElement(TeachingBubble_Condensed_Example_1.TeachingBubbleCondensedExample, null)), React.createElement(index_2.ExampleCard, {title: 'TeachingBubble with Illustration', code: TeachingBubbleIllustrationExampleCode}, React.createElement(TeachingBubble_Illustration_Example_1.TeachingBubbleIllustrationExample, null))), propertiesTables: React.createElement(index_2.PropertiesTableSet, {componentName: 'TeachingBubble'}), overview: React.createElement("div", null, React.createElement(index_1.Link, {target: '_blank', href: 'http://dev.office.com/fabric/components/TeachingBubble'}, "TeachingBubbles"), React.createElement("span", null, " allow the user to display important hints on their web pages with a callout box.")), route: this._url}));
    };
