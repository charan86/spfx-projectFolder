...
var ButtonIconExample = (function (_super) {
    ...
    ButtonIconExample.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'ms-BasicButtonsExample'}, React.createElement(index_1.Label, null, "Icon button"), React.createElement(index_1.Button, {disabled: isDisabled, buttonType: index_1.ButtonType.icon, icon: 'Emoji2', title: 'Emoji', ariaLabel: 'Emoji'})));
    };
