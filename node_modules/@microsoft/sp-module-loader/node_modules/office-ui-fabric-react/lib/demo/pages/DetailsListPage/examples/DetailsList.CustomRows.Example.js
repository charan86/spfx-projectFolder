...
var DetailsListCustomRowsExample = (function (_super) {
    ...
    DetailsListCustomRowsExample.prototype._onRenderCheck = function (props) {
        ...
        }), role: 'button', "aria-pressed": props.isSelected, "data-selection-toggle": true, "aria-label": props.ariaLabel}, React.createElement("input", {type: 'checkbox', checked: props.isSelected})));
    };
    __decorate([
        index_1.autobind
