...
define(["require", "exports", 'react', '../../../../index', './Overlay.Example.scss'], function (require, exports, React, index_1) {
    ...
    var OverlayLightExample = (function (_super) {
        ...
        OverlayLightExample.prototype.render = function () {
            ...
            return (React.createElement("div", null, React.createElement(index_1.Button, {onClick: this._onClick}, "Show the overlay"), isOverlayVisible && (React.createElement(index_1.Overlay, {onClick: this._onClick}, React.createElement("div", {className: 'OverlayExample-content'}, React.createElement("p", null, "I am content within the overlay."))))));
        };
