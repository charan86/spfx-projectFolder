...
define(["require", "exports", 'react', '../../../../index', './PeoplePickerExampleData', '../../../../utilities/object', './PeoplePicker.Types.Example.scss'], function (require, exports, React, index_1, PeoplePickerExampleData_1, object_1) {
    "use strict";
    var suggestionProps = {
    ...
    var PeoplePickerTypesExample = (function (_super) {
        ...
        PeoplePickerTypesExample.prototype.render = function () {
            ...
            return (React.createElement("div", null, currentPicker, React.createElement("div", {className: 'dropdown-div'}, React.createElement(index_1.Dropdown, {label: 'Select People Picker Type', options: [
                { key: 1, text: 'Normal' },
                { key: 2, text: 'Compact' },
                { key: 3, text: 'Members List' },
                { key: 4, text: 'Preselected Items' },
                { key: 5, text: 'Limit Search' }
            ], selectedKey: this.state.currentPicker, onChanged: this._dropDownSelected}), React.createElement(index_1.Toggle, {label: 'Delay Suggestion Results', defaultChecked: false, onChanged: this._toggleChange}))));
        };
