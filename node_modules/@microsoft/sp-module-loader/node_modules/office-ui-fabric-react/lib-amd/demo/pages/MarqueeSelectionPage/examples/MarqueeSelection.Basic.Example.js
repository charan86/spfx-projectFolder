...
define(["require", "exports", 'react', '../../../../index', '../../../../utilities/array', './MarqueeSelection.Basic.Example.scss'], function (require, exports, React, index_1, array_1) {
    "use strict";
    ...
    var MarqueeSelectionBasicExample = (function (_super) {
        ...
        MarqueeSelectionBasicExample.prototype.render = function () {
            var _this = this;
            return (React.createElement(index_1.MarqueeSelection, {selection: this._selection, isEnabled: this.state.isMarqueeEnabled}, React.createElement(index_1.Checkbox, {label: 'Is marquee enabled', defaultChecked: true, onChange: function (ev, isMarqueeEnabled) { return _this.setState({ isMarqueeEnabled: isMarqueeEnabled }); }}), React.createElement("p", null, "Drag a rectangle around the items below to select them:"), React.createElement("ul", {className: 'ms-MarqueeSelectionBasicExample-photoList'}, PHOTOS.map(function (photo, index) { return (React.createElement("div", {key: index, className: index_1.css('ms-MarqueeSelectionBasicExample-photoCell', {
