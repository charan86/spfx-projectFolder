...
define(["require", "exports", 'react', 'react-dom', 'react-addons-test-utils', './connect', './BaseStore', './StoreHost', './StoreSet', './storeKey'], function (require, exports, React, ReactDOM, ReactTestUtils, connect_1, BaseStore_1, StoreHost_1, StoreSet_1, storeKey_1) {
    "use strict";
    ...
    describe('connect', function () {
        it('can observe store changes', function (done) {
            ...
            var root = ReactTestUtils.renderIntoDocument(React.createElement("div", null, React.createElement(StoreHost_1.StoreHost, {stores: localStores}, React.createElement(Connected, null))));
        ...
        it('can throw when requiring a store in an environment without any stores hosted', function () {
            ...
            try {
                ReactTestUtils.renderIntoDocument(React.createElement("div", null, React.createElement(Connected, null)));
            }
            catch (e) {
                threwException = true;
            }
        ...
        it('can throw in an environment that does not contain the required store', function () {
            ...
            var threwException = false;
            try {
                ReactTestUtils.renderIntoDocument(React.createElement(StoreHost_1.StoreHost, {stores: new StoreSet_1.StoreSet()}, React.createElement("div", null, React.createElement(Connected, null))));
            }
            catch (e) {
                threwException = true;
            }
        ...
        it('renders a connected component 1 time when multiple stores fire changes', function (done) {
            ...
            ReactTestUtils.renderIntoDocument(React.createElement("div", null, React.createElement(StoreHost_1.StoreHost, {stores: localStores}, React.createElement(Connected, null))));
