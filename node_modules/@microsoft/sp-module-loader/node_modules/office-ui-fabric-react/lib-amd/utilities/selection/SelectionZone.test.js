define(["require", "exports", 'react', 'react-dom', 'react-addons-test-utils', './index', '../KeyCodes'], function (require, exports, React, ReactDOM, ReactTestUtils, index_1, KeyCodes_1) {
    ...
    function _initializeSelection(selectionMode) {
        ...
        _selectionZone = ReactTestUtils.renderIntoDocument(React.createElement(index_1.SelectionZone, {selection: _selection, selectionMode: selectionMode, onItemInvoked: function (item) { _onItemInvokeCalled++; _lastItemInvoked = item; }}, React.createElement("button", {id: 'toggleAll', "data-selection-all-toggle": true}, "Toggle all selected"), React.createElement("div", {id: 'surface0', "data-selection-index": '0'}, React.createElement("button", {id: 'toggle0', "data-selection-toggle": true}, "Toggle"), React.createElement("button", {id: 'invoke0', "data-selection-invoke": true}, "Invoke")), React.createElement("div", {id: 'surface1', "data-selection-index": '1'}, React.createElement("button", {id: 'toggle1', "data-selection-toggle": true}, "Toggle"), React.createElement("button", {id: 'invoke1', "data-selection-invoke": true}, "Invoke")), React.createElement("div", {id: 'invoke2', "data-selection-index": '2', "data-selection-invoke": true}, React.createElement("button", {id: 'toggle2', "data-selection-toggle": true}, "Toggle")), React.createElement("div", {id: 'surface3', "data-selection-index": '3'})));
